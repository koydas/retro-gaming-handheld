...
| 2 | 2.4" SPI display module (ILI9341) | 320×240, SPI interface, clock ≥40MHz rated | 1 | **Order 1 to run Q1** | Q1 requires a physical display to measure FBTFT throughput — order one unit to run the test. Spec requirement: SPI clock ≥40MHz rated (reject cheaper modules that cap at 16MHz). Full procurement commitment (quantity, final supplier) deferred until Q1 confirms FBTFT viability at 30fps. |
